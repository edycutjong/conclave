...
Thanks for your interest in **Conclave** — agentic DAO governance that reads the
contract before it signs. This project was built for the Casper Agentic
Buildathon and is developed in the open. Bug reports, ideas, and pull requests
are all welcome.
...
- **Agents:** Anthropic Claude (Opus/Haiku) with a deterministic rules fallback
